...
proc LoadImageFromMemory*(fileType: cstring; fileData: ptr ptr cuchar; dataSize: int32): Image {.RLAPI, importc: "LoadImageFromMemory".} # Load image from memory buffer, fileType refers to extension: i.e. "png"
...
proc LoadFontFromMemory*(fileType: cstring; fileData: ptr ptr cuchar; dataSize: int32; fontSize: int32; fontChars: pointer; charsCount: int32): Font {.RLAPI, importc: "LoadFontFromMemory".} # Load font from memory buffer, fileType refers to extension: i.e. "ttf"
proc LoadFontData*(fileData: ptr ptr cuchar; dataSize: int32; fontSize: int32; fontChars: pointer; charsCount: int32; typex: int32): ptr CharInfo {.RLAPI, importc: "LoadFontData".} # Load font data for further use
...
proc LoadWaveFromMemory*(fileType: cstring; fileData: ptr ptr cuchar; dataSize: int32): Wave {.RLAPI, importc: "LoadWaveFromMemory".} # Load wave from memory buffer, fileType refers to extension: i.e. "wav"
